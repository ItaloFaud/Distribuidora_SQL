...
//        int alt = (int) tela.getHeight();
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(400, 500, 120, 30);
    ...
    private void TabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelaMouseClicked
        ...
        int confirm = JOptionPane.showConfirmDialog(null,"Deseja mesmo excluir o funcionário "+a.getNome()+", de Código ("+a.getId()+")","Distribuidora Ítalo",JOptionPane.INFORMATION_MESSAGE);
