 ...
 * @author Hoope
 */
public class Comprar_Pro_Cliente2 extends javax.swing.JFrame {
...
//        int alt = (int) tela.getHeight();
    ...
    public Comprar_Pro_Cliente2(String NCliente, String Subtotal) {
        initComponents();
    ...
    public void Procurar_Cod(String Cod) throws FileNotFoundException{
        ...
        for (int i = 0; i < Procura.length; i++) {
            ...
            try {
                ...
                float ST = Float.parseFloat(Subtotal.getText());
                
                float NST = PTdaC+ST;
                
                Subtotal.setText(NST+"");
...
//                                      Olharrrrrrrrrrrrrrrr
                ...
                Logger.getLogger(Comprar_Pro_Cliente2.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void initComponents() {
        ...
        Comprar.setBounds(250, 400, 220, 40);
        ...
        FimCompra.setBounds(490, 400, 160, 40);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Comprar_Pro_Cliente2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Comprar_Pro_Cliente2().setVisible(true);
            }
        });
    }
    ...
    private String toString(Double Preco_Total) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
}
