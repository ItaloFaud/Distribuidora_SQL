 ...
 * @author Hoope
 */
public class Modelo_Tela extends javax.swing.JFrame {
...
//        int alt = (int) tela.getHeight();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Modelo_Tela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Modelo_Tela().setVisible(true);
            }
        });
    }
