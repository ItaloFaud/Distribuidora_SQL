...
//        int alt = (int) tela.getHeight();
    ...
    private void initComponents() {
        ...
        Comprar.setBounds(260, 350, 160, 40);
        getContentPane().add(JtfSenha);
        JtfSenha.setBounds(230, 290, 210, 30);
    ...
    private void ComprarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ComprarActionPerformed
        ...
        if(sql.Login(c) == true){
            ...
            JOptionPane.showMessageDialog(null, "Login e/ou Senha incorretos","Distribuidora Ítalo",JOptionPane.WARNING_MESSAGE);
            JtfUser.setText("");
            JtfSenha.setText("");
        }
